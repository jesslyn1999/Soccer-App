...
public class EventDbModelDao extends AbstractDao<EventDbModel, Long> {
    ...
    public static class Properties {
        ...
        public final static Property HomeScore = new Property(3, int.class, "homeScore", false, "HOME_SCORE");
        public final static Property HomeShots = new Property(4, int.class, "homeShots", false, "HOME_SHOTS");
        public final static Property AwayTeamId = new Property(5, long.class, "awayTeamId", false, "AWAY_TEAM_ID");
        public final static Property AwayScore = new Property(6, int.class, "awayScore", false, "AWAY_SCORE");
        public final static Property AwayShots = new Property(7, int.class, "awayShots", false, "AWAY_SHOTS");
        public final static Property DateEvent = new Property(8, java.util.Date.class, "dateEvent", false, "DATE_EVENT");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EVENT_DB_MODEL\" (" + //
                ...
                "\"HOME_SCORE\" INTEGER NOT NULL ," + // 3: homeScore
                "\"HOME_SHOTS\" INTEGER NOT NULL ," + // 4: homeShots
                "\"AWAY_TEAM_ID\" INTEGER NOT NULL ," + // 5: awayTeamId
                "\"AWAY_SCORE\" INTEGER NOT NULL ," + // 6: awayScore
                "\"AWAY_SHOTS\" INTEGER NOT NULL ," + // 7: awayShots
                "\"DATE_EVENT\" INTEGER NOT NULL );"); // 8: dateEvent
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, EventDbModel entity) {
        ...
        stmt.bindLong(4, entity.getHomeScore());
        stmt.bindLong(5, entity.getHomeShots());
        stmt.bindLong(6, entity.getAwayTeamId());
        stmt.bindLong(7, entity.getAwayScore());
        stmt.bindLong(8, entity.getAwayShots());
        stmt.bindLong(9, entity.getDateEvent().getTime());
    }
    ...
    public EventDbModel readEntity(Cursor cursor, int offset) {
        EventDbModel entity = new EventDbModel( //
            ...
            cursor.getInt(offset + 3), // homeScore
            cursor.getInt(offset + 4), // homeShots
            cursor.getLong(offset + 5), // awayTeamId
            cursor.getInt(offset + 6), // awayScore
            cursor.getInt(offset + 7), // awayShots
            new java.util.Date(cursor.getLong(offset + 8)) // dateEvent
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, EventDbModel entity, int offset) {
        ...
        entity.setHomeScore(cursor.getInt(offset + 3));
        entity.setHomeShots(cursor.getInt(offset + 4));
        entity.setAwayTeamId(cursor.getLong(offset + 5));
        entity.setAwayScore(cursor.getInt(offset + 6));
        entity.setAwayShots(cursor.getInt(offset + 7));
        entity.setDateEvent(new java.util.Date(cursor.getLong(offset + 8)));
     }
